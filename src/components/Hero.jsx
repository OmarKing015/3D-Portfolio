    ...
    <section className="relative w-fill h-screen mx-auto">
      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100 z `}>
            "Experienced full-stack web developer proficient in React.js, Node.js, Firebase, and MongoDB, delivering seamless user experiences through end-to-end web application development."
          </p>
        </div>
      </div>
